import{_ as e,W as i,X as t,Y as a}from"./framework-b9c734bc.js";const l={},n=a(`<h2 id="概念" tabindex="-1"><a class="header-anchor" href="#概念" aria-hidden="true">#</a> 概念</h2><p><code>JavaServer Pages Tag Library</code> (JSP标准标签库) ，是由Apache组织提供的开源的免费的jsp标签。</p><h2 id="作用" tabindex="-1"><a class="header-anchor" href="#作用" aria-hidden="true">#</a> 作用</h2><p>用于简化和替换jsp页面上的java代码</p><h2 id="使用步骤" tabindex="-1"><a class="header-anchor" href="#使用步骤" aria-hidden="true">#</a> 使用步骤</h2><ol><li></li></ol><p>导入jstl相关jar包；</p><figure><img src="https://raw.githubusercontent.com/hekun97/picture/main/img/JSTL导jar包.png#alt=JSTL导jar包" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure><ol start="2"><li></li></ol><p>在JSP页面中引入标签库：taglib指令： <code>&lt;%@ taglib prefix=&quot;c&quot; uri=&quot;http://java.sun.com/jsp/jstl/core&quot; %&gt;</code>；</p><ol start="3"><li></li></ol><p>使用标签。</p><h2 id="常用的jstl标签" tabindex="-1"><a class="header-anchor" href="#常用的jstl标签" aria-hidden="true">#</a> 常用的JSTL标签</h2><h3 id="if" tabindex="-1"><a class="header-anchor" href="#if" aria-hidden="true">#</a> if</h3><h4 id="概念-1" tabindex="-1"><a class="header-anchor" href="#概念-1" aria-hidden="true">#</a> 概念</h4><p>相当于java代码的if语句。</p><h4 id="使用" tabindex="-1"><a class="header-anchor" href="#使用" aria-hidden="true">#</a> 使用</h4><p>if标签的属性值test为必须填的属性，接受boolean表达式。以下为使用的注意事项：</p><ol><li>如果表达式为true，则显示if标签体内容，如果为false，则不显示标签体内容</li></ol><div class="language-jsp line-numbers-mode" data-ext="jsp"><pre class="language-jsp"><code>&lt;c:if test=&quot;true&quot;&gt;
    &lt;h1&gt;我是真...&lt;/h1&gt;
&lt;/c:if&gt;
