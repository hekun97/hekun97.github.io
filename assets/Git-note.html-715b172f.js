import{_ as i,W as t,X as d,Y as n,Z as e,$ as c,a0 as s,C as l}from"./framework-174e6972.js";const o={},r=s(`<h1 id="git简介" tabindex="-1"><a class="header-anchor" href="#git简介" aria-hidden="true">#</a> Git简介</h1><h2 id="git的概念" tabindex="-1"><a class="header-anchor" href="#git的概念" aria-hidden="true">#</a> Git的概念</h2><p>Git是目前世界上最先进的分布式版本控制系统，使用C语言开发。</p><h2 id="版本控制系统" tabindex="-1"><a class="header-anchor" href="#版本控制系统" aria-hidden="true">#</a> 版本控制系统</h2><p>概念：版本控制最主要的功能是追踪文件的变更，记录每次文件的改动。</p><h3 id="版本控制系统分类" tabindex="-1"><a class="header-anchor" href="#版本控制系统分类" aria-hidden="true">#</a> 版本控制系统分类</h3><p>分为集中式和分布式，其中CVS、SVN为集中式的版本控制系统，Git为分布式版本控制系统。</p><h4 id="集中式版本控制系统" tabindex="-1"><a class="header-anchor" href="#集中式版本控制系统" aria-hidden="true">#</a> 集中式版本控制系统</h4><p>集中式版本控制系统，版本库是集中存放在中央服务器的，而干活的时候，用的都是自己的电脑，所以要先从中央服务器取得最新的版本，然后开始干活，干完活了，再把自己的活推送给中央服务器。中央服务器就好比是一个图书馆，你要改一本书，必须先从图书馆借出来，然后回到家自己改，改完了，再放回图书馆。</p><p><img src="https://hk-docs.oss-cn-chengdu.aliyuncs.com/git/集中式版本控制系统.jpg" alt="central-repo" loading="lazy"></p><h4 id="分布式版本控制系统" tabindex="-1"><a class="header-anchor" href="#分布式版本控制系统" aria-hidden="true">#</a> 分布式版本控制系统</h4><p>分布式版本控制系统根本没有“中央服务器”，每个人的电脑上都是一个完整的版本库，这样，你工作的时候，就不需要联网了，因为版本库就在你自己的电脑上。既然每个人电脑上都有一个完整的版本库，那多个人如何协作呢？比方说你在自己电脑上改了文件A，你的同事也在他的电脑上改了文件A，这时，你们俩之间只需把各自的修改推送给对方，就可以互相看到对方的修改了。 和集中式版本控制系统相比，分布式版本控制系统的安全性要高很多，因为每个人电脑里都有完整的版本库，某一个人的电脑坏掉了不要紧，随便从其他人那里复制一个就可以了。而集中式版本控制系统的中央服务器要是出了问题，所有人都没法干活了。 在实际使用分布式版本控制系统的时候，其实很少在两人之间的电脑上推送版本库的修改，因为可能你们俩不在一个局域网内，两台电脑互相访问不了，也可能今天你的同事病了，他的电脑压根没有开机。因此，分布式版本控制系统通常也有一台充当“中央服务器”的电脑，但这个服务器的作用仅仅是用来方便交换“大家的修改，没有它大家也一样干活，只是交换修改不方便而已。</p><p><img src="https://hk-docs.oss-cn-chengdu.aliyuncs.com/git/分布式版本控制系统.jpg" alt="" loading="lazy"></p><h3 id="集中式vs分布式的区别" tabindex="-1"><a class="header-anchor" href="#集中式vs分布式的区别" aria-hidden="true">#</a> 集中式VS分布式的区别</h3><table><thead><tr><th>区别</th><th>集中式</th><th>分布式</th></tr></thead><tbody><tr><td>版本库</td><td>存放在中央服务器</td><td>没有“中央服务器”</td></tr><tr><td>联网</td><td>必须联网（最大的毛病）</td><td>不需要联网</td></tr><tr><td>安全性</td><td>中央服务器出问题，所有人都没法干活</td><td>某一个人的电脑坏掉了不要紧，随便从其他人哪里复制一个即可</td></tr><tr><td>分支管理</td><td>分支功能不够强大</td><td>极其强大的分支管理</td></tr><tr><td>暂存区</td><td>无</td><td>有</td></tr></tbody></table><h2 id="git流程图解" tabindex="-1"><a class="header-anchor" href="#git流程图解" aria-hidden="true">#</a> Git流程图解</h2><p><img src="https://hk-docs.oss-cn-chengdu.aliyuncs.com/git/Git流程.jpg" alt="Git流程" loading="lazy"></p><h1 id="基本使用" tabindex="-1"><a class="header-anchor" href="#基本使用" aria-hidden="true">#</a> 基本使用</h1><h2 id="快速入门" tabindex="-1"><a class="header-anchor" href="#快速入门" aria-hidden="true">#</a> 快速入门</h2><h3 id="创建仓库-repository" tabindex="-1"><a class="header-anchor" href="#创建仓库-repository" aria-hidden="true">#</a> 创建仓库(repository)</h3><ol><li><p>创建一个空目录；</p><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code>$ <span class="token function">mkdir</span> learngit <span class="token comment"># 创建目录learngit</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>现在，<code>master</code>分支和<code>feature1</code>分支变成了下图所示：</p><p><img src="https://www.liaoxuefeng.com/files/attachments/919023031831104/0" alt="git-br-conflict-merged" loading="lazy"></p><p>用带参数的<code>git log</code>也可以看到分支的合并情况：</p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>$ git log --graph --pretty=oneline --abbrev-commit
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>分支历史如下图所示。</p><p><img src="https://hk-docs.oss-cn-chengdu.aliyuncs.com/git/分支图片.jpg" alt="git-no-ff-mode" loading="lazy"></p></li></ol><h3 id="分支管理原则" tabindex="-1"><a class="header-anchor" href="#分支管理原则" aria-hidden="true">#</a> 分支管理原则</h3><p>在实际开发中，我们应该按照几个基本原则进行分支管理：</p><ol><li><code>master</code>分支应该是非常稳定的，也就是仅用来发布新版本，平时不能在上面干活；</li><li>大家干活都在<code>dev</code>分支上，也就是说，<code>dev</code>分支是不稳定的，到某个时候，比如1.0版本发布时，再把<code>dev</code>分支合并到<code>master</code>上，在<code>master</code>分支发布1.0版本；</li><li>具体的每个人都有自己的分支，在自己的分支上干完活，时不时地往<code>dev</code>分支上合并就可以了。</li></ol><p>所以，团队合作的分支看起来就像这样。</p><p><img src="https://hk-docs.oss-cn-chengdu.aliyuncs.com/git/分支图片2.jpg" alt="git-br-policy" loading="lazy"></p><h3 id="强制删除分支" tabindex="-1"><a class="header-anchor" href="#强制删除分支" aria-hidden="true">#</a> 强制删除分支</h3><p>添加一个新功能时，你肯定不希望因为一些实验性质的代码，把主分支搞乱了，所以，每添加一个新功能，最好新建一个feature分支，在上面开发，完成后，合并，最后，删除该feature分支。</p><p>当我们在feature-need分支中完成开发后，因为一些原因需要放弃该分支，使用<code>git branch -d feature-need</code>命令删除会报错，删除失败。</p><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code>$ <span class="token function">git</span> branch <span class="token parameter variable">-d</span> feature-need
...
|/  
*   cf810e4 conflict fixed
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>总之看上去很乱，有强迫症的童鞋会问：为什么<code>Git</code>的提交历史不能是一条干净的直线？</p><p>其实是可以做到的！</p><p><code>Git</code>有一种称为<code>rebase</code>的操作，有人把它翻译成“变基”。</p><p><img src="https://hk-docs.oss-cn-chengdu.aliyuncs.com/git/l.jpeg" alt="rebase" loading="lazy"></p><p>先不要随意展开想象。我们还是从实际问题出发，看看怎么把分叉的提交变成直线。</p><p>在和远程分支同步后，我们对<code>hello.py</code>这个文件做了两次提交。用<code>git log</code>命令看看：</p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>$ git log --graph --pretty=oneline --abbrev-commit
