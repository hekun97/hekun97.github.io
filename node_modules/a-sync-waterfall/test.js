...
var generateSyncTasks = function(count){
	var tasks = [];
	for(var i=0; i<count; i++) { tasks.push(generatesynctask(i)); } return tasks; var generateasynctasks="function(count){" tasks="[];" for(var i="0;" i<count; tasks.push(generateasynctask(i)); generaterandomtasks="function(count){" math.random()> .5 ? tasks.push(generateAsyncTask(i)) : tasks.push(generateSyncTask(i))
	}
	return tasks;
}
