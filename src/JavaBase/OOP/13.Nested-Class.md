...
![image-20220106152129701](https://hk-docs.oss-cn-chengdu.aliyuncs.com/java/JavaBase/OOP/202305080954531.png)
...
class Outer {
    ...
    class Inner {
        void hello() {
            System.out.println("Hello, " + Outer.this.name);//Hello, Nested
        }
    }
}
```
...
public class Main {
    public static void main(String[] args) {
        ...
        HashMap<String, String> map2 = new HashMap<>() {}; // 匿名类实例
        HashMap<String, String> map3 = new HashMap<>() {//匿名类实例
          //static代码块  
          {
                put("A", "1");
                put("B", "2");
